<?php
if (! class_exists('SLPCEX_Activation')) {
     ...
     *
     */
    class SLPCEX_Activation extends SLP_BaseClass_Activation {
        ...
        function update() {
            ...
            if ($this->slplus->database->is_Extended()) {
                ...
                //
                // We must run an existing install check and rename FIRST.
                //
                ...
                if ( (version_compare($this->addon->options['installed_version'], $this->addon->version , '<'))){
                    ...
                    $this->options['installed_version'] =  $this->addon->version ;  // made persistent via addon admin_init call
                }
